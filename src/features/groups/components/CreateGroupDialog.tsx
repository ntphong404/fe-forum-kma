            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                >
                  ...
                  <div>
                    <div className={`font-semibold text-sm ${privacy === 'PUBLIC' ? 'text-blue-900' : 'text-slate-700'
                      }`}>Công khai</div>
                ...
                >
                  ...
                  <div>
                    <div className={`font-semibold text-sm ${privacy === 'PRIVATE' ? 'text-blue-900' : 'text-slate-700'
                      }`}>Riêng tư</div>
